...
const Header = () => {
    ...
    return (
        <nav style={{ background: "#000923" }}>
            <div className={`p-5 flex ${isMenuOpen ? "border-b-2" : ""}`}>
                <div className=" items-center gap-x-3 flex">
                    <Image className="w-16 rounded-full" src={images.logo} alt="logo" />
                    <p className="text-2xl font-serif font-bold">CryptoWager</p>
                </div>
